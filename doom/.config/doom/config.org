...
#+BEGIN_SRC emacs-lisp :tangle yes
(custom-set-faces!
  `(outline-1  :background ,(doom-color 'bg-alt))
  `(outline-2  :background ,(doom-color 'bg-alt))
  `(outline-3  :background ,(doom-color 'bg-alt))
  `(outline-4  :background ,(doom-color 'bg-alt))
  `(outline-5  :background ,(doom-color 'bg-alt))
  `(outline-6  :background ,(doom-color 'bg-alt))
  `(outline-8  :background ,(doom-color 'bg-alt))
  `(outline-9  :background ,(doom-color 'bg-alt))
