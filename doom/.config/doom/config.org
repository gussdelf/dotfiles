...
#+BEGIN_SRC emacs-lisp :tangle yes
(custom-set-faces!
  `(outline-1 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-2 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-3 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-4 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-5 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-6 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-8 :slant oblique :background ,(doom-color 'bg-alt))
  `(outline-9 :slant oblique :background ,(doom-color 'bg-alt))
  `(org-block-begin-line :slant oblique :weight bold :background ,(doom-color 'bg-alt))
  `(org-block-begin-line :slant oblique :weight bold :background ,(doom-color 'bg-alt))
