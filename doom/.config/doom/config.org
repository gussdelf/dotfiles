...
**** Make headings a little more beatiful
#+begin_src emacs-lisp :tangle yes
(custom-set-faces!
  `(outline-1 :weight ultra-bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-2 :weight extra-bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-3 :weight extra-bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-4 :weight bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-5 :weight bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-6 :weight bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-8 :weight bold :slant italic :background ,(doom-color 'bg-alt))
  `(outline-9 :weight bold :slant italic :background ,(doom-color 'bg-alt)))
#+end_src
